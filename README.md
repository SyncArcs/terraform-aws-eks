...
```hcl
module "eks" {
  source      = "git::https://github.com/SyncArcs/terraform-aws-eks.git?ref=v1.0.0"
  enabled     = true
  name        = local.name
  ...
  map_additional_iam_users = [
    {
      userarn  = "arn:aws:iam::123456789:user/SyncArcs"
      username = "test"
...
## Example
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/SyncArcs/terraform-aws-eks/blob/master/_examples) directory within this repository.
...
## License
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/SyncArcs/terraform-aws-eks/blob/master/LICENSE) file for details.
...
|------|-------------|------|---------|:--------:|
| <a name="input_addons"></a> [addons](#input\_addons) | Manages [`aws_eks_addon`](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eks_addon) resources. | `list(any)` | <pre>[<br>  {<br>    "addon_name": "coredns",<br>    "addon_version": "v1.11.1-eksbuild.4",<br>    "resolve_conflicts": "OVERWRITE"<br>  },<br>  {<br>    "addon_name": "kube-proxy",<br>    "addon_version": "v1.31.2-eksbuild.3",<br>    "resolve_conflicts": "OVERWRITE"<br>  },<br>  {<br>    "addon_name": "vpc-cni",<br>    "addon_version": "v1.19.0-eksbuild.1",<br>    "resolve_conflicts": "OVERWRITE"<br>  }<br>]</pre> | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/SyncArcs/terraform-aws-eks"` | no |
